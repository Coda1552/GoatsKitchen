...
public class JelloBlock extends Block {
    public static final IntegerProperty BITES = BlockStateProperties.BITES;
    protected static final VoxelShape[] SHAPE_BY_BITE = new VoxelShape[]{
            Block.box(1.5D, 0.0D, 1.5D, 14.5D, 13.0D, 14.0D),
            Block.box(3.5D, 0.0D, 1.5D, 14.5D, 13.0D, 14.0D),
            Block.box(5.5D, 0.0D, 1.5D, 14.5D, 13.0D, 14.0D),
            Block.box(14.5D, 0.0D, 1.5D, 14.5D, 13.0D, 14.5D)};

    public JelloBlock(AbstractBlock.Properties p_i48434_1_) {
        super(p_i48434_1_);
    ...
    private ActionResultType eat(IWorld p_226911_1_, BlockPos p_226911_2_, BlockState p_226911_3_, PlayerEntity p_226911_4_) {
        if (!p_226911_4_.canEat(false)) {
            ...
            p_226911_4_.getFoodData().eat(3, 0.2F);
