...
public class FilletstoneClusterConfiguration implements FeatureConfiguration {
   public static final Codec<FilletstoneClusterConfiguration> CODEC = RecordCodecBuilder.create((p_160784_) -> {
      ...
      })).apply(p_160784_, FilletstoneClusterConfiguration::new);
   });
   ...
   public FilletstoneClusterConfiguration(int p_160772_, IntProvider p_160773_, IntProvider p_160774_, int p_160775_, int p_160776_, IntProvider p_160777_, FloatProvider p_160778_, FloatProvider p_160779_, float p_160780_, int p_160781_, int p_160782_) {
