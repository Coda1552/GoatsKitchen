...
public class GKBlocks {
    ...
    public static final RegistryObject<Block> POTTED_LAWYERS_WIG_MUSHROOM = REGISTER.register("potted_lawyers_wig_mushroom", () -> new FlowerPotBlock(LAWYERS_WIG_MUSHROOM.get(), BlockBehaviour.Properties.of(Material.DECORATION).noCollission().instabreak()));
    ...
    public static final RegistryObject<Block> CHILI_PEPPER_PLANT_BASE = REGISTER.register("chili_pepper_plant_base", () -> new ChiliPepperBaseBlock(BlockBehaviour.Properties.of(Material.PLANT, MaterialColor.NETHER).noCollission().instabreak().sound(SoundType.WEEPING_VINES)));
}