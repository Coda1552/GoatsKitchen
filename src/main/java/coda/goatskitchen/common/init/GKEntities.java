...
public class GKEntities {
    ...
    public static final RegistryObject<EntityType<LonghornEntity>> LONGHORN = create("longhorn", EntityType.Builder.of(LonghornEntity::new, MobCategory.CREATURE).sized(1.55f, 1.8f));
