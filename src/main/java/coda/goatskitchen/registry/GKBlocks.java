...
public class GKBlocks {
    ...
    public static final RegistryObject<Block> BLENDER = REGISTER.register("blender", () -> new BlenderBlock(BlockBehaviour.Properties.of(Material.GLASS).strength(1.5f).noOcclusion().sound(SoundType.GLASS)));
